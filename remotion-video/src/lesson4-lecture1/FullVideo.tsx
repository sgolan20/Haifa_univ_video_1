...
const IntroOverlay: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ opacity }}>
      <OffthreadVideo
        src={staticFile("lesson4-lecture1/video/intro_talking_head.mp4")}
        muted
...
/**
 * FullVideo — Master composition for Lesson 4 / Lecture 1
  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={TITLE_CARD_FRAMES}>
        <Audio src={staticFile("lesson4-lecture1/audio/full_narration.mp3")} volume={1} />
      </Sequence>
