      ...
      >
        ...
        >
          ...
          <div style={{ position: "relative", width: 340, height: 340, flex: 1 }}>
            {/* Tree */}
            <Img
              src={staticFile("video1/images/shot7_5_tree.png")}
              style={{
                position: "absolute",
                bottom: 0,
                left: "50%",
            ...
            <Img
              src={staticFile("video1/images/shot7_5_apple.png")}
              style={{
                position: "absolute",
                left: "50%",
                top: appleY,
        ...
        >
          ...
          <div style={{ position: "relative", flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Img
              src={staticFile("video1/images/shot7_5_picasso.png")}
              style={{
                width: 260,
                height: "auto",
                borderRadius: 12,
        ...
        >
          ...
          <div style={{ position: "relative", flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            />
            <Img
              src={staticFile("video1/images/shot7_5_eureka.png")}
              style={{
                width: 180,
                height: "auto",
                filter: bulbLit > 0
